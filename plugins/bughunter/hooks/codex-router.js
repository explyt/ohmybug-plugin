...
const ROUTING = [
  ...
  'Run the light submit_review first, then immediately arm a 240s heartbeat on the current Codex thread; wake on needs_files/done/failed, show only compact bughunt progress, then wait_review and read review_report at terminal.',
