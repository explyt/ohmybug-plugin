...
const ROUTING = [
  ...
  'Immediately after every successful submit_review (including deep), create a four-minute heartbeat with automation_update and set targetThreadId to the current thread; it must call get_findings, answer needs_files first, print only one compact bughunt status line, and delete itself on done or failed.',
