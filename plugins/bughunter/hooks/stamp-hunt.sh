  ...
  submit_review)
    ...
    TREEOK=0 REFOK=0
    {
      ...
      if [ -n "$SENT" ] && ID=$(ohmybug_sent_is_local "$SENT") && [ -n "$ID" ]; then
        ...
        # (0.93): a KDoc sentence deleted after the hunt is prose the reviewers
