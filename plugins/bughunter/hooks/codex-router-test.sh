...
for phrase in ("submit_review", "wait_review", "automation_update", "targetThreadId", "four-minute heartbeat", "poll_after_s=30", "timeout_s=240", "answer needs_files first", "review_report", "get_attestation", "never run fast and deep in parallel"):
...
for phrase in ("poll_after_s=30", "timeout_s=240", "`get_findings` every 45 seconds", "needs_files"):
