...
for phrase in ("submit_review", "wait_review", "automation_update", "targetThreadId", "poll_after_s=30", "timeout_s=180", "answer needs_files first", "review_report", "get_attestation", "never run fast and deep in parallel"):
...
for phrase in ("poll_after_s=30", "timeout_s=180", "`get_findings` every 45 seconds", "needs_files"):
